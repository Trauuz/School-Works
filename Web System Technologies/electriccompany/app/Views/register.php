    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-lg-8 mx-auto">
                ...
                <p class="lead">
                    Register to access exclusive customer benefits, service history,
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card h-100 text-center p-4 feature-item">
                    ...
                    <p class="text-muted small">
                        Get priority booking for all electrical services and maintenance
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card h-100 text-center p-4 feature-item">
                    ...
                    <p class="text-muted small">
                        Access to member-only discounts and seasonal promotions
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card h-100 text-center p-4 feature-item">
                    ...
                    <p class="text-muted small">
                        Track all your electrical services and maintenance records
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card h-100 text-center p-4 feature-item">
                    ...
                    <p class="text-muted small">
                        Dedicated customer support and emergency assistance
                    </p>
                </div>
            </div>
                ...
                <div class="card shadow-lg border-0">
                    <div class="card-body p-5">
                        ...
                        <div class="text-center mb-4">
                            <h2 class="display-6 fw-bold text-primary-custom mb-3">
                                Create Your Account
                            </h2>

                            <p class="lead text-muted">
                                Join the Puihaha Electric family today
                            </p>
                        </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input
                                            type="text"
                                            class="form-control form-control-lg <?= isset($validation['first_name']) ? 'is-invalid' : '' ?>"
                                            id="first_name"
                                            name="first_name"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input
                                            type="text"
                                            class="form-control form-control-lg <?= isset($validation['last_name']) ? 'is-invalid' : '' ?>"
                                            id="last_name"
                                            name="last_name"
                                            value="<?= old('last_name') ?>"
                                            required
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input
                                            type="text"
                                            class="form-control form-control-lg <?= isset($validation['address']) ? 'is-invalid' : '' ?>"
                                            id="address"
                                            name="address"
                                            value="<?= old('address') ?>"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input
                                            type="text"
                                            class="form-control form-control-lg <?= isset($validation['city']) ? 'is-invalid' : '' ?>"
                                            id="city"
                                            name="city"
                                            value="<?= old('city') ?>"
                                            required
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select
                                            class="form-select form-select-lg <?= isset($validation['state']) ? 'is-invalid' : '' ?>"
                                            id="state"
                                            name="state"
                                            required
                                        >
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input
                                            type="text"
                                            class="form-control form-control-lg <?= isset($validation['zip_code']) ? 'is-invalid' : '' ?>"
                                            id="zip_code"
                                            name="zip_code"
                                            value="<?= old('zip_code') ?>"
                                            placeholder="12345"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input
                                            type="password"
                                            class="form-control form-control-lg <?= isset($validation['confirm_password']) ? 'is-invalid' : '' ?>"
                                            id="confirm_password"
                                        ...
                                        <?php if (isset($validation['confirm_password'])): ?>
                                            <div class="invalid-feedback">
                                                <?= esc($validation['confirm_password']) ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                            ...
                            <div class="mb-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="terms">
                                        I agree to the
                                        <a href="#" class="text-primary-custom">
                                            Terms of Service
                                        </a>
                                        and
                                        <a href="#" class="text-primary-custom">
                                ...
                                <div class="form-check mt-2">
                                    ...
                                    <label class="form-check-label" for="newsletter">
                                        Subscribe to our newsletter for electrical tips
                                        and special offers
                                    </label>
                                </div>
                            </div>
        ...
        <div class="row text-center">
            <div class="col-lg-8 mx-auto">
                ...
                <p class="lead text-muted mb-4">
                    We take your privacy seriously and use industry-standard
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="security-item">
                            ...
                            <p class="text-muted small">
                                All data is encrypted using 256-bit SSL security
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="security-item">
                            <i
                                class="fas fa-user-shield text-success mb-3"
                                style="font-size: 3rem;"
                            ></i>
                    ...
                    <div class="col-md-4">
                        <div class="security-item">
                            <i
                                class="fas fa-lock text-success mb-3"
                                style="font-size: 3rem;"
                            ></i>
