            ...
            <div class="col-lg-3 col-md-6">
                <div class="card h-100 text-center p-4 feature-item">
                    ...
                    <p class="text-muted mb-2">
                        ...
                        info@Puihahaelectric.com
                    </p>

                    <p class="text-muted mb-0">
                        <strong>Emergency:</strong><br>
                        emergency@Puihahaelectric.com
                    </p>
                </div>
            </div>
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="lead text-muted">
                                ...
                                24 hours with a detailed quote for your project.
                            </p>
                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        ...
                                        <option
                                            value="residential_wiring"
                                            <?= old('service_type') == 'residential_wiring' ? 'selected' : '' ?>
                                        >
                                            Residential Wiring
                                        </option>

                                        <option
                                            value="commercial_electrical"
                                            <?= old('service_type') == 'commercial_electrical' ? 'selected' : '' ?>
                                        >
                                        ...
                                        <option
                                            value="panel_upgrade"
                                            <?= old('service_type') == 'panel_upgrade' ? 'selected' : '' ?>
                                        >
                                            Panel Upgrade
                                        </option>

                                        <option
                                            value="lighting_installation"
                                            <?= old('service_type') == 'lighting_installation' ? 'selected' : '' ?>
                                        >
                                        ...
                                        <option
                                            value="smart_home"
                                            <?= old('service_type') == 'smart_home' ? 'selected' : '' ?>
                                        >
                                        ...
                                        <option
                                            ...
                                            <?= old('service_type') == 'solar_installation' ? 'selected' : '' ?>
                                        >
                                            Solar Installation
                                        </option>
                                        ...
                                        <option
                                            value="ev_charging"
                                            <?= old('service_type') == 'ev_charging' ? 'selected' : '' ?>
                                        >
                                            EV Charging Station
                                        </option>
                                        ...
                                        <option
                                            ...
                                            <?= old('service_type') == 'emergency_repair' ? 'selected' : '' ?>
                                        >
                                            Emergency Repair
                                        </option>
                                        ...
                                        <option
                                            value="maintenance"
                                            <?= old('service_type') == 'maintenance' ? 'selected' : '' ?>
                                        >
                                            Maintenance Service
                                        </option>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea
                                        ...
                                        name="message"
                                        rows="5"
                                        placeholder="Please describe your electrical project, including location, timeline, and any specific requirements..."
                                        required
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        ...
                                        <label
                                            ...
                                            for="consent"
                                        >
                                            I agree to be contacted by Puihaha Electric
                                            regarding my inquiry and understand that my
        ...
        <div class="row text-center">
            <div class="col-lg-8 mx-auto">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    ...
                    <a
                        href="mailto:emergency@Puihahaelectric.com"
    ...
    <div class="container">
        ...
        <div class="row text-center mb-4">
            <div class="col-lg-8 mx-auto">
                ...
                <p class="lead text-muted">
                    Visit our office or call to schedule an on-site consultation.
                </p>
                    ...
                    <div class="card-body p-0">
                        ...
                        >
                            <div class="text-center">
                                ...
                                <i
                                    class="fas fa-map-marked-alt mb-3"
                                ...
                                <p class="mb-0">
                                    123 Electric Avenue, Power City, PC 12345
                                </p>
