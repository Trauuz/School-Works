        ...
        <div class="row text-center mb-5">
            <div class="col-lg-8 mx-auto">
                ...
                <p class="lead text-muted">
                    From simple repairs to complex installations, we provide safe, reliable, and efficient
                    electrical services tailored to your specific needs.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="display-5 fw-bold text-primary-custom mb-3">
                    <i class="fas fa-home text-secondary-custom me-3"></i>
                    Residential Services
                </h2>
                <p class="lead text-muted">
                    Professional electrical services for your home, ensuring safety, efficiency, and comfort
                    for your family.
                </p>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 p-4 feature-item">
                    ...
                    <p class="text-muted mb-3">
                        Complete home wiring services including new construction, rewiring, and electrical
                        system upgrades to meet modern safety standards.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 p-4 feature-item">
                    ...
                    <p class="text-muted mb-3">
                        Electrical panel upgrades and replacements to handle increased power demands and
                        improve home safety and efficiency.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 p-4 feature-item">
                    ...
                    <p class="text-muted mb-3">
                        Indoor and outdoor lighting installations, including LED upgrades, landscape lighting,
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 p-4 feature-item">
                    ...
                    <p class="text-muted mb-3">
                        Transform your home with smart electrical systems, automated controls, and IoT device
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 p-4 feature-item">
                    ...
                    <p class="text-muted mb-3">
                        Electric vehicle charging station installation for convenient and efficient home
                        charging of your electric vehicle.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 p-4 feature-item">
                    ...
                    <p class="text-muted mb-3">
                        Quick and reliable electrical repair services for outlets, switches, fixtures, and
                        other electrical components in your home.
                    </p>
...
<section class="section-padding">
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="display-5 fw-bold text-primary-custom mb-3">
                    <i class="fas fa-building text-secondary-custom me-3"></i>
                    Commercial Services
                </h2>
                <p class="lead text-muted">
                    Reliable electrical solutions for businesses, offices, retail spaces, and industrial
                    facilities.
                </p>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 p-4 feature-item">
                    ...
                    <p class="text-muted mb-3">
                        Complete electrical installations for new commercial buildings, tenant improvements,
                        and electrical system expansions.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 p-4 feature-item">
                    ...
                    <p class="text-muted mb-3">
                        High-voltage power distribution systems, transformers, and electrical infrastructure
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 p-4 feature-item">
                    ...
                    <p class="text-muted mb-3">
                        Installation of security systems, surveillance cameras, access control, and structured
                        cabling for data networks.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 p-4 feature-item">
                    ...
                    <p class="text-muted mb-3">
                        Specialized electrical services for manufacturing facilities, warehouses, and
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 p-4 feature-item">
                    ...
                    <p class="text-muted mb-3">
                        Preventive maintenance programs and ongoing electrical system support to ensure
                        reliable operation and minimize downtime.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 p-4 feature-item">
                    ...
                    <p class="text-muted mb-3">
                        Energy audits, efficiency upgrades, and power quality improvements to reduce operating
...
<section class="section-padding bg-light-custom">
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="display-5 fw-bold text-primary-custom mb-3">
                    <i class="fas fa-solar-panel text-secondary-custom me-3"></i>
                    Solar &amp; Renewable Energy
                </h2>
                <p class="lead text-muted">
                    Sustainable energy solutions to reduce your carbon footprint and energy costs with
                ...
                <div class="card h-100 p-4 feature-item">
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-md-9">
                            ...
                            <p class="text-muted mb-3">
                                Complete solar photovoltaic system design and installation for residential and
                ...
                <div class="card h-100 p-4 feature-item">
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-md-9">
                            ...
                            <p class="text-muted mb-3">
                                Battery storage solutions to store solar energy and provide backup power
                                during outages.
                            </p>
                            ...
                            <ul class="list-unstyled text-muted small">
                                ...
                                <li><i class="fas fa-check text-success me-2"></i>Energy management systems</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="card h-100 p-4 feature-item">
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-md-9">
                            ...
                            <p class="text-muted mb-3">
                                Comprehensive energy assessments and consultation to determine the best
                ...
                <div class="card h-100 p-4 feature-item">
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-md-9">
                            ...
                            <p class="text-muted mb-3">
                                Ongoing maintenance and monitoring services to ensure optimal performance of
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-lg-8 mx-auto">
                ...
                <p class="lead mb-4">
                    Electrical emergencies don't wait for business hours. Our emergency response team is
                    available 24/7 to handle urgent electrical issues and ensure your safety.
                </p>
    ...
    <div class="container">
        ...
        <div class="row text-center mb-5">
            <div class="col-lg-8 mx-auto">
                ...
                <p class="lead text-muted">
                    A streamlined approach to delivering exceptional electrical services from consultation
                    to completion.
                </p>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="text-center feature-item">
                    <div
                        class="process-step bg-primary text-white rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"
                    ...
                    <p class="text-muted">
                        Free consultation to understand your needs and provide expert recommendations
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="text-center feature-item">
                    ...
                    <p class="text-muted">
                        Thorough site assessment and detailed project planning with transparent pricing
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="text-center feature-item">
                    ...
                    <p class="text-muted">
                        Professional installation by licensed electricians using quality materials and
                        equipment
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="text-center feature-item">
                    ...
                    <p class="text-muted">
                        Quality inspection, testing, and ongoing support with comprehensive warranties
                    </p>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-8">
                ...
                <p class="lead text-muted mb-4">
                    ...
                    you with all your electrical needs, from simple repairs to complex installations.
                </p>
            </div>
